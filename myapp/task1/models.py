...
class Game(models.Model):
    ...
    cost = models.DecimalField(max_digits=10, decimal_places=2, help_text="Цена")
    size = models.DecimalField(max_digits=3, decimal_places=3, help_text="Размер файлов в GB")
